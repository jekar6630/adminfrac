                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-xs bg-lime waves-effect" type="button">
                                                    <li class="material-icons btn-editfuncion" data-toggle="modal" data-target="#myModalEditFuncion" value="{{ $funcion->id }}">edit</li>
                                                </button>
                                            </td>
                                        </tr>
    ...
    <div id="myModalEditFuncion" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('funciones.update') }}">

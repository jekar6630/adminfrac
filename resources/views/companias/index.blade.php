                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    @foreach($companias as $compania)
                                        ...
                                        <tr>
                                            <td>{{ $compania->id }}</td>
                                            <td>{{ $compania->name }}</td>
                                            <td>{{ $compania->street }}</td>
                                            <td>{{ $compania->phone1 }}</td>
                                            <td>{{ $compania->phone2 }}</td>
                                            <td>{{ $compania->email }}</td>
                                            <td>
                                                <button class="btn btn-xs bg-lime waves-effect" type="button">
                                                    <li class="material-icons btn-editdireccion" data-toggle="modal" data-target="#myModalEditCompania" value="{{ $compania->id }}">edit</li>
                                                </button>
                                            </td>
                                        </tr>
    ...
    <div id="myModalEditCompania" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('companias.update') }}">

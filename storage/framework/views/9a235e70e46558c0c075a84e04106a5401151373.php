                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <?php $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($user->function->name); ?></td>
                                            <td>
                                                <a class="thumbnail btn-edit-user-photo">
                                                    <?php if( $user->urlfoto == '-'): ?>
                                                        -
                                                    <?php else: ?>
                                                        <img src="fotos/<?php echo e($user->urlfoto); ?>" class="img-responsive">
                                                    <?php endif; ?>
                                                </a>
                                            </td>
                                            <td>
                                                <button class="btn btn-xs bg-lime waves-effect" type="button">
                                                    <li class="material-icons btn-edit-user" data-toggle="modal" data-target="#myModalEditUser" value="<?php echo e($user->id); ?>">edit</li>
                                                </button>
                                                <?php if( $user->urlfoto == '-'): ?>
                                                    <button class="btn btn-xs btn-info bg-lime waves-effect" type="button">
                                                        <li class="material-icons btn-edit-user" data-toggle="modal" data-target="#myModalEditPhoto" value="<?php echo e($user->id); ?>">search</li>
                                                    </button>
                                                <?php else: ?>
                                                    <button class="btn btn-xs btn-warning bg-lime waves-effect" type="button">
                                                        <li class="material-icons btn-edit-user" data-toggle="modal" data-target="#myModalEditPhoto" value="<?php echo e($user->id); ?>">update</li>
                                                    </button>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                ...
                                <div class="form-line">
                                    <select class="form-control show-tick" name="company" id="company">
                                        ...
                                        <?php $__currentLoopData = $companias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $compania): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($compania->id); ?>"><?php echo e($compania->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-line">
                                    <select class="form-control show-tick" name="funcion" id="funcion">
                                        ...
                                        <?php $__currentLoopData = $funciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $funcion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($funcion->id); ?>"><?php echo e($funcion->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
    ...
    <div id="myModalEditPhoto" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="<?php echo e(route('usuarios.updatephoto')); ?>" enctype="multipart/form-data" name="formphoto" id="formphoto">
